========================================================================
ATL (ACTIVE TEMPLATE LIBRARY) : DokanSSHProperty プロジェクトの概要
========================================================================

この DokanSSHProperty プロジェクトは、ユーザーがダイナミック リンク ライ
...
DokanSSHProperty.idl
    このファイルには、プロジェクトで定義されるタイプ ライブラリの IDL 定義、
    インターフェイス、およびコクラスが含まれます。
    このファイルは MIDL コンパイラによって処理され、次のものが生成されます。
        C++ のインターフェイス定義と GUID 宣言 (DokanSSHProperty.h)
        GUID 定義                              (DokanSSHProperty_i.c)
        タイプ ライブラリ                      (DokanSSHProperty.tlb)
        マーシャリング コード                  (DokanSSHProperty_p.c および dlldata.c)

DokanSSHProperty.h
    このファイルには、C++ のインターフェイス定義および 
    DokanSSHProperty.idl. で定義される項目の GUID 宣言が含まれます。
    コンパイル中に MIDL によって再生成されます。

DokanSSHProperty.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    DokanSSHProperty.pch とプリコンパイル済み型ファイル StdAfx.obj 
    をビルドするために使用します。
...
DokanSSHPropertyps.vcproj
	...
	DokanSSHProperty_i.c と DokanSSHProperty_p.c が生成され
        ます。

DokanSSHPropertyps.def
